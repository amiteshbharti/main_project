...
/*
//CHECK NAMES BLANK
	if(f1.txtfname.value=="" || f1.txtfathername.value =="" || f1.txtlname.value=="" || f1.txtuname.value =="" ||f1.txtpassword.value =="" ||f1.txtretypepassword.value =="" ||f1.txtemailid.value =="" ||f1.txtcontactnumber.value=="" ||f1.txtstate.value =="" ||f1.txtpin.value =="")
		{
...
//CHECK SPACE IN FIELDS		
	if(f1.txtfname.value.trim() =="" || f1.txtfathername.value.trim() =="" || f1.txtlname.value.trim() ==" " || f1.txtuname.value.trim() =="" ||f1.txtpassword.value.trim() =="" ||f1.txtretypepassword.value.trim() =="" ||f1.txtemailid.value.trim() =="" ||f1.txtcontactnumber.value.trim() =="" ||f1.txtstate.value.trim() =="" ||f1.txtpin.value =="")
		{
